...
//     return (
//         <div>
//             <div className="text-center text-5xl font-bold my-5 flex justify-center items-center" >
//                 <h1>Projects</h1>
//             </div>
//             {/* Card 1 */}
//             <div className="flex flex-row justify-center items-center gap-6 flex-wrap py-8 px-6 md:flex-col lg:flex-row xl:flex-row">
//             <Card title="Shadow Marketing" description="Built a platform for a marketing agency to offer various marketing services to companies.Integrated SMTP for automated email notifications upon user form submission. " 
...
//             {/* Card 2 */}
//             <Card title="BrainOPedia" description="Built a tool to organize bookmarked tweets and YouTube videos.Enabled sharing of collections between users"
//             gitLink="https://github.com/ansh-pachauri/Second-Brain.git"
//             demoLink="#"
//             imageSrc="/brain.png" />

//             {/* Card 3 */}
//             <Card title="Chat Application" description="Real-time WebSocket chat application enabling seamless one-on-one conversations."
//             gitLink="https://github.com/ansh-pachauri/Chat-app.git"
//             demoLink="#"
//             imageSrc="/chat.png" />

//             {/* card 4 */}
//             <Card title =" Video Chat Application" description="A real-time webrtc video chat application for seamless one-on-one conversation using socket.io "
